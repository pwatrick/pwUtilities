...
create_netezza_queries <- function(drug_concept_id, biomarker_concept_id, table_name, table_type, conn,...) {
...
INNER JOIN(SELECT * FROM lipid_drugs_ancestor_tbl_20210308090052) s3
